	...
	<section id="portfolio-section" class="px-4 lg:px-8 py-16  relative">
        ...
        <div class="flex gap-8 flex-col md:flex-row">
            ...
            <p class="capitalize xl:w-1/2 text-stone-500 mb-8">
                Whether it’s turning a busy city corner into a refreshing oasis or sponsoring major public events, our portfolio showcases innovative strategies that deliver measurable results. Each project is a testament to our commitment to creativity, community, and the belief that every interaction counts.
         </p>
            <!-- Main text end -->
        </div>
        <!-- Text wrapper end -->
